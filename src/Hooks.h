...
namespace Hooks
{
	...
	public:
		...
		static bool func(RE::ActorEquipManager* const, RE::Actor*, RE::TESBoundObject*, RE::ExtraDataList*, std::uint32_t, const RE::BGSEquipSlot*, bool, bool, bool, bool, const RE::BGSEquipSlot*);
